...
"use strict";var h=require("choo/html"),URL=require("../url"),InfoBar=require("../info-bar");module.exports=function(e){var t=e.item,r=e.index,n=t.url?t.url:"/item/"+t.id,a=URL({url:n});return function(){var e=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),t=document.createElement("tr");t.setAttribute("class","StoryList-item");var r=document.createElement("td");r.setAttribute("class","v-top pv2 f6 tr pr2"),e(r,[arguments[0],"."]);var n=document.createElement("td");n.setAttribute("class","v-top pv2 f6 f5-ns");var a=document.createElement("a");a.setAttribute("href",arguments[1]),a.setAttribute("class","link"),e(a,["\n        ",arguments[2],"\n      "]);var i=document.createElement("span");e(i,[arguments[3]]);var o=document.createElement("span");return e(o,[arguments[4]]),e(n,["\n      ",a,"\n      ",i,"\n      ",o,"\n    "]),e(t,["\n    ",r,"\n    ",n,"\n  "]),t}(r,n,t.title.replace(/\s([^\s<]+)\s*$/," $1"),a,InfoBar({item:t}))};
...
"use strict";function itemText(e){var t=function(){var e=(require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),document.createElement("p"));return e}();return t.innerHTML=e,t}var h=require("choo/html"),URL=require("../url"),InfoBar=require("../info-bar"),PollOptions=require("./poll-options"),Item=function(e){var t=e.item,o=e.pollOptions,r=e.onLoad;return function(){var e=require("/home/river/Code/hackernews-choo/node_modules/on-load/index.js"),t=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),o=document.createElement("div"),r=arguments;e(o,function(){r[2](o)},function(){},"o1"),o.setAttribute("class","Item");var n=document.createElement("a");return n.setAttribute("href",arguments[0]),n.setAttribute("class","link"),t(n,[arguments[1]]),t(o,["\n    ",n,"\n    ",arguments[3],"\n    ",arguments[4],"\n    ",arguments[5],"\n    ",arguments[6],"\n  "]),o}(t.url,t.title,r,URL(t),InfoBar({item:t}),t.text?itemText(t.text):"","poll"===t.type?PollOptions({pollOptions:o}):"")};module.exports=Item;
...
"use strict";var h=require("choo/html"),sanitizeHTML=require("sanitize-html"),decode=require("ent/decode"),PollOptions=function(e){var t=e.pollOptions,n=t.filter(function(e){if(!e.deleted)return!0}).map(function(e){var t=function(){var e=(require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),document.createElement("span"));return e}();return t.innerHTML=sanitizeHTML(decode(e.text)),function(){var e=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),t=document.createElement("li");t.setAttribute("class","mv3");var n=document.createElement("span");e(n,[arguments[0]]);var r=document.createElement("span");return r.setAttribute("class","f6 near-black dib"),e(r,[arguments[1]," points"]),e(t,["\n        ",n,"\n        ",r,"\n      "]),t}(t,e.score)});return function(){var e=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),t=document.createElement("ul");return t.setAttribute("class","list pl0"),e(t,["\n    ",arguments[0],"\n  "]),t}(n)};module.exports=PollOptions;
...
"use strict";var h=require("choo/html"),sheetify=0,prefix=(null||!0)&&"_2132c44c",initialState={text:null};module.exports=function(){var e=arguments.length<=0||void 0===arguments[0]?initialState:arguments[0],t=e.text;return function(){var e=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),t=document.createElement("div");t.setAttribute("class","Loading "+arguments[1]+" mv5 mw5 center tc pa3 bg-near-white ba b--light-gray");var n=document.createElement("div");n.setAttribute("class","center dark-green"),e(n,[arguments[0]]);var r=document.createElement("div");r.setAttribute("class","loader-inner ball-pulse center");var i=document.createElement("div"),a=document.createElement("div"),c=document.createElement("div");return e(r,["\n      ",i,"\n      ",a,"\n      ",c,"\n    "]),e(t,["\n    ",n,"\n    ",r,"\n  "]),t}(t?t:"Loading...",prefix)};
...
"use strict";var h=require("choo/html"),URL=function(e){if(!e||!e.url||"/item/"===e.url.substring(0,6))return"";var r=e.url.match(/^https?\:\/\/([^\/?#]+)(?:[\/?#]|$)/i),t=r&&r[1];return function(){var e=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),r=document.createElement("span");return r.setAttribute("class","domain f6"),e(r,["(",arguments[0],")"]),r}(t)};module.exports=URL;
...
(null||!0)&&"_30e6652c",
(null||!0)&&"_c5687757",hooks.onStateChange=function(n,e){storage.save(e)},hooks.onError=function(n){console.error(n)};var app=choo(hooks);app.model(require("./model")),app.router(function(n){return[n("/",StoryList),n("/page/:pageNumber",StoryList),n("/item/:itemId",Item),n("/user/:userId",User)]});var tree=app.start();document.body.appendChild(tree);
...
"use strict";var h=require("choo/html"),ItemList=require("../components/item-list/list"),Loading=require("../components/loading"),Root=require("../components/root"),Home=function(e,o,r){function t(){r("fetchItemsByPage",m),window.scrollTo(0,0)}var n=e.storyCollection,i=e.storiesPerPage,a=e.isLoadingItems,s=e.currentItems,u=e.params,c=[],d=o.params,m=parseInt(u.pageNumber,10)||1,l=d?parseInt(o.params.pageNumber,10)||1:1,h=void 0,p=void 0;return l!==parseInt(m,10)?(t(),LoadingView()):(s.length>0&&s.forEach(function(e){c.push(n.get(e))}),a?(h=LoadingView(),p=""):(h=ItemList({collection:c,storiesPerPage:i,pageNumber:m}),p=Navigation({pageNumber:m})),Root(function(){var e=require("/home/river/Code/hackernews-choo/node_modules/on-load/index.js"),o=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),r=document.createElement("div"),t=arguments;return e(r,function(){t[0](r)},function(){},"o0"),r.setAttribute("class","HomePage silver"),o(r,["\n    ",arguments[1],"\n  "]),r}(t,[h,p])))},LoadingView=function(){return function(){var e=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),o=document.createElement("div");return e(o,[arguments[0]]),o}(Loading({text:"Fetching Stories..."}))},Navigation=function(e){var o=e.pageNumber,r=function(){var e=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),o=document.createElement("a");return o.setAttribute("href","/page/"+arguments[0]),e(o,["More"]),o}(o+1),t=r;return o>1&&(t=function(){var e=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),o=document.createElement("span"),r=document.createElement("a");return r.setAttribute("href","/page/"+arguments[0]),e(r,["Previous"]),e(o,[r," | ",arguments[1]]),o}(o-1,r)),function(){var e=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),o=document.createElement("div");return o.setAttribute("class","w-100 mt4"),e(o,["\n    ",arguments[0],"\n  "]),o}(t)};module.exports=Home;
...
"use strict";var h=require("choo/html"),StoryItem=require("../components/item"),Loading=require("../components/loading"),CommentList=require("../components/comments/list"),Root=require("../components/root");module.exports=function(o,e,t){function n(){c&&t("fetchComments",c.id)}var r=o.storyCollection,i=o.commentCollection,m=o.pollOptionCollection,l=o.params,s=parseInt(l.itemId,10),c=r.get(s),a=i.get(s),d=m.get(s);if(!c)return t("fetchItems",s),Root(Loading({text:"Loading story..."}));if("poll"===c.type&&!d)return t("fetchPollOptions",c.id),Root(Loading({text:"Loading poll..."}));"poll"===c.type&&d&&(d=Array.from(d.values()));var p=StoryItem({item:c,pollOptions:d,onLoad:n}),u=a?CommentList({comments:a}):Loading({text:"Loading comments..."});return Root(function(){var o=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),e=document.createElement("div");return e.setAttribute("class","ItemPage"),o(e,[arguments[0]]),e}([p,u]))};
...
"use strict";var h=require("choo/html"),sanitizeHTML=require("sanitize-html"),approx=require("approximate-time"),Loading=require("../components/loading"),Root=require("../components/root"),User=function(e,t,r){var n=e.params.userId,o=e.user;return o&&n===o.id?Root(function(){var e=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),t=document.createElement("div");t.setAttribute("class","User navy center cf");var r=document.createElement("h2");r.setAttribute("class","mb0"),e(r,[arguments[0]]);var n=document.createElement("div");n.setAttribute("class","f6");var o=document.createElement("a");o.setAttribute("href","https://news.ycombinator.com/submitted?id="+arguments[1]),o.setAttribute("class","link"),e(o,["\n        submissions\n      "]);var s=document.createElement("a");s.setAttribute("href","https://news.ycombinator.com/comments?id="+arguments[2]),s.setAttribute("class","link"),e(s,["\n        comments\n      "]),e(n,["\n      ",o,"\n      |\n      ",s,"\n    "]);var a=document.createElement("div");a.setAttribute("class","mv3");var i=document.createElement("dl");i.setAttribute("class","dib mr5");var c=document.createElement("dd");c.setAttribute("class","f6 f5-ns b ml0"),e(c,["Created"]);var u=document.createElement("dd");u.setAttribute("class","f4 f3-ns b ml0"),e(u,[arguments[3]]),e(i,["\n        ",c,"\n        ",u,"\n      "]);var m=document.createElement("dl");m.setAttribute("class","dib mr5");var d=document.createElement("dd");d.setAttribute("class","f6 f5-ns b ml0"),e(d,["Karma"]);var l=document.createElement("dd");return l.setAttribute("class","f4 f3-ns b ml0"),e(l,[arguments[4]]),e(m,["\n        ",d,"\n        ",l,"\n      "]),e(a,["\n      ",i,"\n      ",m,"\n    "]),e(t,["\n    ",r,"\n    ",n,"\n    ",a,"\n    ",arguments[5],"\n  "]),t}(o.id,o.id,o.id,timeAgo(o.created),o.karma,About(o.about))):(r("fetchUser",n),Loading({text:"Fetching user..."}))},timeAgo=function(e){var t=approx(1e3*e);return"just now"!==t&&(t+=" ago"),function(){var e=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),t=document.createElement("span");return e(t,[arguments[0]]),t}(t)},About=function(e){if(!e)return"";var t=function(){var e=(require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),document.createElement("p"));return e}();return t.innerHTML=sanitizeHTML(e),function(){var e=require("/home/river/Code/hackernews-choo/node_modules/yo-yoify/lib/appendChild.js"),t=document.createElement("div");t.setAttribute("class","bg-near-white pa3");var r=document.createElement("h3");return r.setAttribute("class","mt0"),e(r,["About"]),e(t,["\n    ",r,"\n    ",arguments[0],"\n  "]),t}(t)};module.exports=User;
